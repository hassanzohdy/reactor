...
export default function SelectInput({ id, label, onChange, lazyLoading, request, mapResponse = defaultMapResponse, labelId, placeholder, required, value, items, groups, imagable, iconable, multiple, readOnly, none, ...otherProps }) {
