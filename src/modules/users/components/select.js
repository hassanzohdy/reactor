...
import FormInput from 'reactor/form/components/form-input';
...
export default function CountrySelect() {
    ...
    const Lister = React.forwardRef((props, ref) => {
    ...
    const filterOptions = (data, options) => {
        ...
        return data.filter(item => {
            return item.label.match(new RegExp(inputValue));
        });
    };
